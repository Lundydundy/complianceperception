                ...
                <div class="row" id="tabs">
                    ...
                    <div class="col-md-8">
                        <section class='tabs-content'>
                            <article style={tab === "tabs-1" ? { display: "block" } : { display: "none" }} id='tabs-1' class="animate__animated animate__fadeIn">
                            ...
                            <article style={tab === "tabs-2" ? { display: "block" } : { display: "none" }} id='tabs-2' class="animate__animated animate__fadeIn">
                            ...
                            <article style={tab === "tabs-3" ? { display: "block" } : { display: "none" }} id='tabs-3' class="animate__animated animate__fadeIn">
                            ...
                            <article style={tab === "tabs-4" ? { display: "block" } : { display: "none" }} id='tabs-4' class="animate__animated animate__fadeIn">
                            ...
                            <article style={tab === "tabs-5" ? { display: "block" } : { display: "none" }} id='tabs-5' class="animate__animated animate__fadeIn">
                            ...
                            <article style={tab === "tabs-6" ? { display: "block" } : { display: "none" }} id='tabs-6' class="animate__animated animate__fadeIn">
